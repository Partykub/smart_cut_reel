"""FastAPI adapter for the Phase 2 audio extraction service."""
...
def create_app(service: AudioExtractionService | None = None) -> FastAPI:
    app = FastAPI(title="Smart Cut Reel Audio Extraction Service", version="0.1.0")
    audio_service = service or AudioExtractionService()
