...
export const horizontalSlots: SlotDefinition[] = [
  { key: "main_video", required: true, description: "Primary horizontal clip" },
  ...
  { key: "background_style", required: false, description: "Background fill mode" }
];
