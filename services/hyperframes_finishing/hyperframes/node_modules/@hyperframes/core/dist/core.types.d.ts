 ...
 */
export declare function fpsToNumber(fps: Fps): number;
/**
 ...
 */
export declare function fpsToFfmpegArg(fps: Fps): string;
/**
...
export type FpsParseResult = {
    ...
    ok: false;
    reason: "empty" | "not-a-number" | "non-positive" | "out-of-range" | "invalid-fraction" | "ambiguous-decimal";
};
/**
 ...
 */
export declare function parseFps(input: string | number): FpsParseResult;
/**
 ...
 */
export declare function parseFpsWithDefault(input: string | number | undefined): FpsParseResult;
...
export declare const VALID_CANVAS_RESOLUTIONS: readonly CanvasResolution[];
/**
 ...
 */
export declare function normalizeResolutionFlag(input: string | undefined): CanvasResolution | undefined;
 ...
 */
export declare const COMPOSITION_VARIABLE_TYPES: readonly ["string", "number", "color", "boolean", "enum"];
